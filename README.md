...
4. **Group** detected braces, binding each to its group-id + member callouts.
   ...
   `{` or the apex of a V points at it), members opposite; braces drawn as
...
- A leader-line fragment can still pass for a brace and bind a false group.
  This is the main precision cost in the group benchmark above; details in
  `docs/adr/0002`.
